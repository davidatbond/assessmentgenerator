...
function hideDivs () {
    var divstohide = ["s2a","s2c","q3","q4","task5","task6","task7","task8","task9"];    
    for (var c = 0; c<divstohide.length; c++) {
        var mydiv = document.getElementById(divstohide[c]);
...
function generateKey() {
    var studentid = document.getElementById("studentnumber").value; //get student id from form
    var idcount = 0;
    ...
    for (idcount =0; idcount <examidslen; idcount++) {
        ...
        if (studentid == examids[idcount][0]){
    ...
    //Task 3
    document.getElementById("q3").style.display="block";  //redisplay question
    document.getElementById("s2a").style.display="block";//redisplay question
    
    item1=examID.substr(28,2);  //Find the item code for s2a from the examID
    qDiv = document.getElementById('s2a');    
    qDiv.innerHTML += "<ul>" + findItem(item1,s2alist);
    
    document.getElementById("s2c").style.display="block";//redisplay question
    item2=examID.substr(26,2);  //Find the item code for s2c from the examID
    qDiv = document.getElementById('s2c');    
    qDiv.innerHTML += "<ul>" + findItem(item2,s2clist);
    ...
    qDiv = document.getElementById('q3');
    qDiv.innerHTML += "<h2 style='color:green'>Answer on page: " + answer + "</h2><hr>";
    
    
    //TASK 4
    answer="";
    altanswer="";
    document.getElementById("q4").style.display="block";  //redisplay question
    //item 1 stays the same
    
    //display question data for q4a and q4b
    item2=examID.substr(24,2);  //Find the item code for q4a from the examID
    qDiv = document.getElementById('q4a');    
    qDiv.innerHTML += findItem(item2,q4alist);
    
    item3=examID.substr(22,2);  //Find the item code for q4b from the examID
    qDiv = document.getElementById('q4b');    
    qDiv.innerHTML += findItem(item3,q4blist);
    
    if (item1 == "3G" && item2 == "1Y") {
        switch (item3) {
            case "CC":
                answer="401 + 403";
                altanswer="413";
    ...
    qDiv = document.getElementById('q4');
    qDiv.innerHTML += "<h2 style='color:green'>Answer on page: " + answer + ". Alt page number: " + altanswer + "</h2><hr>";
    
    
    //TASK 5
    answer="";
    altanswer="";
    document.getElementById("task5").style.display="block";  //redisplay question
    ...
    qDiv.innerHTML += findItem(item3,q5list) + "</p>" ;
    ...
    qDiv = document.getElementById('task5');
    qDiv.innerHTML += "<h2 style='color:green'>Answer on page: " + answer + "</h2><hr>"
    ...
    answer="";
    altanswer="";
    document.getElementById("task6").style.display="block";  //redisplay question
    item1=examID.substr(18,2);  //Find the item code for q6 from the examID
    qdiv =  document.getElementById('q6');
    qdiv.innerHTML += findItem(item1,q6list);
    switch (item1) {
        case "OZ":
            answer="601";
            break;
    ...
    qDiv = document.getElementById('task6');
    qDiv.innerHTML += "<h2 style='color:green'>Answer on page: " + answer + "</h2><hr>";
    
    //TASK 7
    answer="701";
    document.getElementById("task7").style.display="block";  //redisplay question
    qDiv =  document.getElementById('q7');
    qDiv.innerHTML += "<ol type='a'><li>" + findItem(examID.substr(16,2),q7list) + "</li><li>" +  findItem(examID.substr(14,2),q7list) + "</li><li>"+  findItem(examID.substr(12,2),q7list) + "</li><li>"+  findItem(examID.substr(10,2),q7list) + "</li><li>"+  findItem(examID.substr(8,2),q7list) +   "</li><li>"+  findItem(examID.substr(6,2),q7list) + "</li></ol>";
    qDiv = document.getElementById('task7');
    qDiv.innerHTML += "<h2 style='color:green'>Answer on page: " + answer + "</h2><hr>";
        
    //TASK 8
    answer="";
    altanswer="";
     document.getElementById("task8").style.display="block";  //redisplay question
    ...
    qDiv.innerHTML += '<ol type="a"><li>' + findItem(item1,q8list) + "</li><li>" + findItem(item2,q8list); + "</li></ol>";
    ...
    qDiv = document.getElementById('task8');
    qDiv.innerHTML += "<h2 style='color:green'>Answer on page: " + answer + " and " + altanswer + "</h2><hr>";
    
    //TASK 9
    answer="";
    altanswer="";
    document.getElementById("task9").style.display="block";  //redisplay question
    ...
    qDiv.innerHTML += '<ol type="a"><li><p>Investigate the term <strong>' + findItem(item1,q8list) + '</strong>, then</li><li>Describe <strong><em>in your own words</em></strong>:';
    ...
    qDiv = document.getElementById('task9');
    qDiv.innerHTML += "<h2 style='color:green'>Answer on page: " + answer + "</h2><hr>";
}
